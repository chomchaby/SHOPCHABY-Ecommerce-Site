    ...
    const getProducts = async () => {
      ...
      try {
            const response = await axiosPrivate.get
              (HOME_PRODUCTS_URL+'/category='+categoryName+'/maxprice='+maxp+'/minprice='+minp+'/sort='+sort);
...
}, [axiosPrivate, categoryName, maxPrice, minPrice, sort])
        ...
        <div className="filterItem">
          ...
          <div className="inputItem">
            ...
            <input
              ...
              value={minPrice}
              onChange={(e) =>
                setMinPrice((prev) => (e.target.validity.valid ? e.target.value : prev))
              }
            />
          </div>
        </div> 
