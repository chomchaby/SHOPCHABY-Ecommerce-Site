...
const FeaturedProducts = ({type}) => {
  ...
  return (
    <div className='featuredProducts'>
        <div className="top">
            <h1>{type} products</h1>
            <p>Discover irresistible discounts on your favorite items! Limited-time offers await – grab them before they're gone and enjoy savings galore while you shop.</p>
        </div>
